...
Betrieblich fehlen für einen echten Produktivbetrieb noch: eine Off-host-Backup-Kopie, Verschlüsselung von Backup-Artefakten, ein produktiver E-Mail-Zustellprovider für Einladungen, eine getrennte DB-Rolle für Runtime vs. Migration, und ein nachgewiesener Restore-Drill. Diese Lücken sind größtenteils bereits im Code/den Docs als bewusste Pilot-Grenzen benannt, nicht verschwiegen.
